/***
 * Tiny-query: A selector library that doesn't do much. 2kb compressed.
 *
 * (c) 2015 – 2017 James Futhey. All Rights Reserved.
 * MIT licensed (see LICENSE)
 */
(function (window, document) {
  if (!window || !document) return false; // Just bail
